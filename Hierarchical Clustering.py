...
# ML Success Criteria: Achieve Silhouette coefficient of at least 0.5
...
from AutoClean import AutoClean   # For Auto Pre-processing
from sklearn.pipeline import make_pipeline      # Pipeline creation
from sklearn.preprocessing import MinMaxScaler  # For Data Scaling
from scipy.cluster.hierarchy import linkage, dendrogram  # Dendogram creation
from sklearn.cluster import AgglomerativeClustering      # For clustering
from sklearn import metrics      # For Evaluation
from clusteval import clusteval  # For Evaluation
import numpy as np               # For Arithmatic operation
...
uni.to_sql('University_Clustering', con = engine, if_exists = 'replace', chunksize = 1000, index = False)
...
# ------------------------
# Missing Data: Identified Missing Data in columns: SAT, SF ratio, GradRate
...
metrics.silhouette_score(df_pipelined, hc_2clust.labels_)
